...
const config = {
  ...
  faucetName: process.env.FAUCET_NAME || "Catnet Faucet",
  ...
  faucetHourMax:
    Number.parseInt(process.env.FAUCET_HOUR_MAX || "100", 10) * BTC,
  faucetDayMax: Number.parseInt(process.env.FAUCET_DAY_MAX || "1000", 10) * BTC,
  faucetWeekMax:
    Number.parseInt(process.env.FAUCET_WEEK_MAX || "2000", 10) * BTC,
  ...
  explorerUrl:
    process.env.EXPLORER_URL || "https://catnet-mempool.btcwild.life/tx/",
