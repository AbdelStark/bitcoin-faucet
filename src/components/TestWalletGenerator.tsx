    ...
    <div>
      ...
      {wallet.address && (
        <div>
          ...
          <p className="warning">
            Do not use these for any non-test environment! They are generated
            locally on your browser but they are not secure and might incur
            losses if used on a mainnet environment.
          </p>
        </div>
      )}
    </div>
